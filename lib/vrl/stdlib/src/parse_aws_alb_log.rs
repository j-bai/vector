    ...
    test_function![
        ...
        one {
            ...
            want: Ok(value!({"actions_executed": "forward",
                             "chosen_cert_arn": Value::Null,
                             "classification": Value::Null,
                             "classification_reason": Value::Null,
                             "client_host": Bytes(b"192.168.131.39:2817"),
                             "domain_name": Value::Null,
                             "elb": "app/my-loadbalancer/50dc6c495c0c9188"),
                             "elb_status_code": "200"),
                             "error_reason": Value::Null,
                             "matched_rule_priority": "0"),
                             "received_bytes": Integer(34),
                             "redirect_url": Value::Null,
                             "request_creation_time": "2018-07-02T22:22:48.364000Z"),
                             "request_method": "GET"),
                             "request_processing_time": Float(NotNan(0.0)),
                             "request_protocol": "HTTP/1.1"),
                             "request_url": "http://www.example.com:80/"),
                             "response_processing_time": Float(NotNan(0.0)),
                             "sent_bytes": Integer(366),
                             "ssl_cipher": Value::Null,
                             "ssl_protocol": Value::Null,
                             "target_group_arn": "arn:aws:elasticloadbalancing:us-east-2:123456789012:targetgroup/my-targets/73e2d6bc24d8a067"),
                             "target_host": "10.0.0.1:80"),
                             "target_port_list": Array(["10.0.0.1:80")]),
                             "target_processing_time": Float(NotNan(0.001)),
                             "target_status_code": "200"),
                             "target_status_code_list": Array(["200")]),
            ...
            two {
                ...
                want: Ok(value! ({"actions_executed": "authenticate,forward"),
                                  ...
                                  "received_bytes": Integer(0),
                                  "redirect_url": Value::Null,
                                  "request_creation_time": "2018-07-02T22:22:48.364000Z"),
                                  "request_method": "GET"),
                                  "request_processing_time": Float(NotNan(0.086)),
                                  "request_protocol": "HTTP/1.1"),
                                  "request_url": "https://www.example.com:443/"),
                                  "response_processing_time": Float(NotNan(0.037)),
                                  "sent_bytes": Integer(57),
                                  "ssl_cipher": "ECDHE-RSA-AES128-GCM-SHA256"),
                                  "ssl_protocol": "TLSv1.2"),
                                  "target_group_arn": "arn:aws:elasticloadbalancing:us-east-2:123456789012:targetgroup/my-targets/73e2d6bc24d8a067"),
                                  "target_host": "10.0.0.1:80"),
                                  "target_port_list": Array(["10.0.0.1:80")]),
                                  "target_processing_time": Float(NotNan(0.048)),
                                  "target_status_code": "200"),
                                  "target_status_code_list": Array(["200")]),
                                  "timestamp": "2018-07-02T22:23:00.186641Z"),
                ...
                three {
                    ...
                    ({"actions_executed": "redirect"),
                      ...
                      "response_processing_time": Float(NotNan(0.0)),
                      "sent_bytes": Integer(257),
                      "ssl_cipher": "ECDHE-RSA-AES128-GCM-SHA256"),
                      "ssl_protocol": "TLSv1.2"),
                      "target_group_arn": "arn:aws:elasticloadbalancing:us-east-2:123456789012:targetgroup/my-targets/73e2d6bc24d8a067"),
                      "target_host": "10.0.0.66:9000"),
                      "target_port_list": Array(["10.0.0.66:9000")]),
                      "target_processing_time": Float(NotNan(0.002)),
                      "target_status_code": "200"),
                      "target_status_code_list": Array(["200")]),
                      "timestamp": "2018-07-02T22:23:00.186641Z"),
